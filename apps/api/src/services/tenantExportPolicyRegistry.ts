...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "ai_agent_schedules": tablePolicy("org_id", {"included":["id","org_id","partner_id","agent_id","baseline_schedule_id","kind","cron","timezone","sweep_kinds","enabled","last_enqueued_at","last_occurrence_key","created_by","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["last_run_summary"]}),
  ...
  "alert_rules": tablePolicy("org_id", {"included":["id","org_id","partner_id","template_id","name","target_type","target_id","is_active","created_at","managed_by_monitor_id"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["override_settings"]}),
  "alert_templates": tablePolicy("org_id", {"included":["id","org_id","partner_id","name","description","category","severity","title_template","message_template","auto_resolve","cooldown_minutes","is_built_in","created_at","updated_at","managed_by_monitor_id","rationale"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["conditions","targets","auto_resolve_conditions"]}),
  ...
  "automations": tablePolicy("org_id", {"included":["id","org_id","partner_id","name","description","enabled","on_failure","last_run_at","run_count","created_by","created_at","updated_at","managed_by_agent_id","managed_by_monitor_id"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["trigger","conditions","actions","notification_targets"]}),
  ...
  "recovery_tokens": tablePolicy("org_id", {"included":["id","org_id","device_id","snapshot_id","restore_type","status","created_by","created_at","expires_at","authenticated_at","completed_at","used_at"],"reviewedIncluded":["authorization_principal_kind","authorization_principal_id","authorization_grant_revision","authorization_state","authorization_denial_code","authorization_checked_at"],"excludedSensitive":["token_hash"],"excludedOpen":["target_config"]}),
  ...
  "software_deployments": tablePolicy("org_id", {"included":["id","org_id","name","software_version_id","install_method_id","deployment_type","target_type","schedule_type","scheduled_at","dispatched_at","maintenance_window_id","created_by","created_at"],"reviewedIncluded":["dependency_fingerprint"],"excludedSensitive":[],"excludedOpen":["target_ids","options"]}),
